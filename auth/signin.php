  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="ms-auto navbar-nav">
        <li class="nav-item">
          <a class="btn btn-primary" href="<?= sprintf('%s/auth/?a=signup', App::base_url()); ?>" role="button">Daftar</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container d-grid mt-auto py-3">
  <form action="<?= sprintf('%s/system/Auth/Signin.php', App::base_url()); ?>" class="card mx-auto" method="post">
    ...
    <div class="card-footer">
      <div class="d-flex column-gap-3">
        <button class="btn btn-primary flex-fill" name="signin" type="submit">Masuk</button>
        <a class="btn btn-outline-primary flex-fill" href="<?= sprintf('%s/auth/?a=signup', App::base_url()); ?>" role="button">Daftar</a>
      </div>
    </div>
  </form>
</div>
